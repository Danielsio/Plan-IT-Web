              ...
              <Card.Text>
                {studyPlan ? (
                  <>
                    ...
                    <div>
                      Start Date Time of Plan: {new Date(studyPlan.startDateTimeOfPlan).toLocaleDateString()}
                    </div>
                    <div>
                      End Date Time of Plan: {new Date(studyPlan.endDateTimeOfPlan).toLocaleDateString()}
                    </div>
                    <div>
