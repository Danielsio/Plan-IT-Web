        ...
        <Col md={7} lg={8}>
          ...
          <Card className="card-container generate-plan-card">
            ...
            <Card.Body>
              ...
              {loadingStudyDetails ? (
                  <>
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"50%", display: "inline-block", margin: "0 20% 0 0"}} />
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"30%", display: "inline-block"}}/>
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"50%", display: "inline-block", margin: "0 20% 0 0"}}/>
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"30%", display: "inline-block"}}/>
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"100%", display: "inline-block", margin: "0 100px 0 0"}} />
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"100%", display: "inline-block", margin: "0 100px 0 0"}} />
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"100%", display: "inline-block", margin: "0 100px 0 0"}} />
                  </>
          ...
          <Card className="card-container generate-plan-card">
            <Card.Body>
              ...
              {loadingStudyDetails ? (
                  <>
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"20%", display: "inline-block", margin: "0 80% 0 0"}} />
                    <Skeleton variant="rounded" height={20} animation="wave" style={{width:"100%", display: "inline-block", margin: "0 100px 0 0"}} />
                  </>
