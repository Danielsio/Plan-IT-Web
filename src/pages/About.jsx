            ...
            <Card className="about-page-container my-5 py-4">
                <Card.Body>
                    ...
                    <Card.Text className="text-center">
                        ...
                        takes into account a student's interests, strengths, and weaknesses
                        to craft a curriculum that maximizes their potential.
                    </Card.Text>
                    <Card.Text className="text-center">
                    ...
                    <Card.Text className="text-center">
                        ...
                        commitment to student success and can make a significant impact on
